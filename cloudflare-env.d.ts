/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 05d87222b01c3f2483539b659d5b022d)
// Runtime types generated with workerd@1.20250604.0 2025-05-05 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NEXTJS_ENV: "production";
		NEXT_PUBLIC_CHAT_SERVICE_HOST: "website-do.tom-s-correia4779.workers.dev";
		NASA_API_KEY: string;
		WEBSITE_DO: DurableObjectNamespace /* WebsiteDO from website-do */;
		CHAT_SERVICE: Fetcher /* website-do */;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "NEXT_PUBLIC_CHAT_SERVICE_HOST" | "NASA_API_KEY">> {}
}
